...
void midi_write_multiple_euclidean(t_music_data *music_data, t_sensors *sensors_data)
{
	...
	music_data->quarter_value_goal = (uint32_t)map_number((uint32_t)sensors_data->photodiode_1, 0, 4096, 100000000, 50000000);
	...
	// 5000000
	music_data->current_quarter_value = (uint32_t)map_number((uint32_t)sensors_data->photodiode_1, 0, 4096, 100000000, 4500000); // RM THAT !!
	...
	for (uint8_t current_euclidean_data = 0; current_euclidean_data < EUCLIDEAN_DATAS_LENGTH; current_euclidean_data++)
	{
		...
		if (!euclidean_datas[current_euclidean_data].initialized)
		{
			...
			{
				euclidean_datas[current_euclidean_data].euclidean_steps_length = (uint8_t)map_number((uint32_t)sensors_data->temperature_1, 0, 2048, 13, 26);
			...
			{
				euclidean_datas[current_euclidean_data].octaves_size = 3;
				euclidean_datas[current_euclidean_data].euclidean_steps_length = (uint8_t)map_number((uint32_t)sensors_data->temperature_2, 0, 2048, 15, 30);
