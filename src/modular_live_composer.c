...
void midi_write_multiple_euclidean(t_music_data *music_data, t_sensors *sensors_data)
{
	...
	music_data->quarter_value_goal = (uint32_t)map_number((uint32_t)sensors_data->photodiode_1, 0, 4096, 100000000, 500000);
	...
	music_data->current_quarter_value = (uint32_t)map_number((uint32_t)sensors_data->photodiode_1, 0, 4096, 100000000, 500000); // RM THAT !!
